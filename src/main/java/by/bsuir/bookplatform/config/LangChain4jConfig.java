...
//                ))
                .systemMessageProvider(chatId -> (
                        ...
                        Оформлять заказ можно только на 7 дней вперед, начиная с завтрашнего по отношению к текущей дате.
                        Время заказа - с 9:00 до 18:00 с промежутками в полчаса: 9:00, 9:30, 10:00 ... 18:00.
